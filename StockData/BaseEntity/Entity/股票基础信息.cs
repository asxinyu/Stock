...
namespace StockData.Entity
{
    ...
    [DataObject]
    [Description("股票基础信息")]
    [BindIndex("IX_StockInfo_Name", false, "Name")]
    [BindIndex("IX_StockInfo_StartDate", false, "StartDate")]
    [BindTable("StockInfo", Description = "股票基础信息", ConnName = "BaseStock", DbType = DatabaseType.None)]
    public partial class StockInfo : IStockInfo
    {
        #region 属性
        ...
        /// <summary>类型。备用</summary>
        [DisplayName("类型")]
        [Description("类型。备用")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn("Kind", "类型。备用", "")]
    ...
    public partial interface IStockInfo
    {
        #region 属性
        /// <summary>股票编码</summary>
        String Code { get; set; }
